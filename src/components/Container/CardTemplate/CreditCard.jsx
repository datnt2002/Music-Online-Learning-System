...
const CreditCard = () => {
  return (
    <div className="space-y-16">
      {/* ratio 12/7 */}
      <div className="w-72 h-42 m-auto bg-red-100 rounded-xl relative text-white shadow-2xl ">
        <img
          alt="card-credit"
        ...
        <div className="w-full px-8 absolute top-8">
          <div className="flex justify-between">
            ...
            <img className="w-14 h-14" src="https://i.imgur.com/bbPHJVe.png" alt="logo-credit-card" />
          </div>
          <div className="pt-1">
